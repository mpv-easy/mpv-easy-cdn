...
<main>
    ...
    <div class="centered-div">
        ...
        <p id="status">Loading challenge <em>js-refresh</em>...</p>
...
<p>
	...
	Disable such plugins for this domain (for example, JShelter) if you encounter any issues.
            ...
            <noscript>
                <p>Sadly, you may need to enable JavaScript to get past this challenge. This is required because AI companies have changed the social contract around how website hosting works.</p>
            </noscript>
        

        <p><small>If you have any issues contact the site administrator and provide the following Request Id: <em>0e0acb29c1e5c6e09ed0ae4575a3a4d0</em></small></p>
    </div>
    ...
    <footer>
        <center>
            <p>
                Protected by <a href="https://git.gammaspectra.live/git/go-away">go-away</a> :: Request Id <em>0e0acb29c1e5c6e09ed0ae4575a3a4d0</em>
        ...
        <script type="text/javascript">window.location = "/.well-known/.git.gammaspectra.live/git/go-away/cmd/go-away/challenge/js-refresh/verify-challenge?__goaway_challenge=js-refresh\u0026__goaway_id=0e0acb29c1e5c6e09ed0ae4575a3a4d0\u0026__goaway_redirect=%2F~jagrg%2Fdotfiles%2Ftree%2Fmaster%2Fitem%2Fcommon%2F.config%2Fmpv%2Fscripts%2Fprint-playlist.lua%3F__goaway_challenge%3Djs-refresh%26__goaway_id%3D0e0acb29c1e5c6e09ed0ae4575a3a4d0\u0026__goaway_token=013af062dacd8fd059c766e94b9b0b8834fd96396f58f3381713dee4a43f1b50";</script>
